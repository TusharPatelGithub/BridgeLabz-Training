...
namespace BridgeLabz.AddressBookSystem
{
        ...
        {
            // EF Core requires a primary key
            public int Id { get; set; }

            // Foreign key linking this contact to its AddressBookEntity
            public int AddressBookEntityId { get; set; }
            public AddressBookEntity? AddressBookEntity { get; set; }
            ...
            // UC0 - Welcome Message (Private) - kept for compatibility, not persisted
