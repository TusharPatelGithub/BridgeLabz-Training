...
namespace FundooNotesApp.Repository.Migrations
{
    ...
    [Migration("20260825083007_AddTagsAndNoteTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Entity.Tag", b =>
                {
            ...
            modelBuilder.Entity("NoteTags", b =>
                {
                    b.HasOne("Repository.Entity.Note", null)
                        .WithMany()
                        .HasForeignKey("NotesNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repository.Entity.Tag", null)
                        .WithMany()
