    ...
    class AddressBookMenu
    {
        public async Task Start()
        {
            ...
            while (!exit)
            {
                ...
                Console.WriteLine("20. Save Address Book to Database");
                Console.WriteLine("21. Load Address Book from Database");
                ...
                try
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 20: await service.SaveAddressBookToDatabase(); break;
                        case 21: await service.LoadAddressBookFromDatabase(); break;
                        case 22: exit = true; Console.WriteLine("Exiting...");break;
                        default:
