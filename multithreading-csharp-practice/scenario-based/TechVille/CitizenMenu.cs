...
public class CitizenMenu
{
    ...
    public async Task Start()
    {
        while (true)
        {
            ...
            switch (choice)
            {
                case 1: AddCitizenMenu(); break;
                case 2: system.ViewCitizens(); break;
                case 3:
                    {
                ...
                case 4:
                    ...
                    break;
                case 5: system.SortCitizens(); break;
                case 6: system.BenchmarkSearch(1000000); break;
                case 7: system.BenchmarkSorting(100000); break;
                case 8:
                    ...
                    break;
                case 9: system.ProcessComplaint(); break;
                case 10:
                    ...
                    break;
                case 11: system.ProcessServiceRequest(); break;
                case 12:
                ...
                case 13:
                    ...
                    break;
                case 14: system.ProcessEmergencyService(); break;
                case 15:
                    Console.Write("Enter page name: ");
                    system.VisitPage(Console.ReadLine());
                    break;
                case 16: system.GoBack(); break;
                case 17: system.GoForward(); break;
                case 18:
                    {
                    Console.Write("Zone: ");
                ...
                case 19:Console.Write("Zone: "); system.ViewZone(Console.ReadLine()); break;
                case 20: system.BackupCitizens();break;
                case 21: system.GenerateReport(); break;
                case 22: system.LoadServices(); break;
                case 23: await system.ProcessCitizensAsync(); break;
                case 24: return;
            }
        }
    }
